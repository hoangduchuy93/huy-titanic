...
if choice == 'Overview':
    ...
    fig, ax = plt.subplots()
    ax.bar(['False Negative', 'True Negative', 'True Possitive', 'False Positive'],
    [FN, TN, TP, FP])
    st.pyplot(fig)
    #ROC curve
    st.write('ROC curve')
...
#requirement.txt chứa các lib cần cho project
#cần lib nào bỏ hết vào file này

#Procfile: chứa tâp tin cần chạy
#(trường hợp này là streamlit_titanic.py)
